# HoloViz-Agents Questions and Feedback

## Does this plugin work in practice?

This seems like an amazing and extensive resource.

Question: Is it correct to assume this repository is created with extensive help from Claude? And less with human involvement?

Answer: ???

Question: Do the agents, resources and skills work in practice?
...
Question: Are these really [Copilot - Custom Agents](https://code.visualstudio.com/docs/copilot/customization/custom-agents)?
...
## Should HoloViz-MCP Provide HoloViz-Agents skills, resources and agents?

HoloViz-MCP might be used in more contexts than Claude, VS Code etc. development environments. HoloViz-MCP might provide access to the Agents, Resources and Skills in this repository.

Question: Would it be valuable for HoloViz-MCP to provide the Agents, Resources and Skills via `holoviz_agents`, `holoviz_resources` and `holoviz_skills` tools?

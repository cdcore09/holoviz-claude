...
**See**: [Panel Patterns](./patterns/panel-patterns.md)
...
**See**: [HoloViews Patterns](./patterns/holoviews-patterns.md)
...
**See**: [Datashader Patterns](./patterns/datashader-patterns.md)
...
**See**: [GeoViews Patterns](./patterns/geoviews-patterns.md)
...
**See**: [Param Patterns](./patterns/param-patterns.md)
...
**See**: [Integration Patterns](./patterns/integration-patterns.md)
...
```
→ See [Panel Patterns](./patterns/panel-patterns.md#pattern-1-param-based-dashboard) for full example
...
```
→ See [Datashader Patterns](./patterns/datashader-patterns.md#pattern-1-basic-datashading) for full example
...
gts.OSM() * points
```
→ See [GeoViews Patterns](./patterns/geoviews-patterns.md#pattern-1-basic-map) for full example
...
|----------|---------------------|------|
| Interactive dashboard | Param-based Dashboard | [Panel Patterns](./patterns/panel-patterns.md) |
| Multi-page app | Multi-page Application | [Panel Patterns](./patterns/panel-patterns.md) |
| 1M+ point scatter | Datashader Scatter | [Datashader Patterns](./patterns/datashader-patterns.md) |
| Geographic map | Basic Map with Tiles | [GeoViews Patterns](./patterns/geoviews-patterns.md) |
| Overlaid plots | HoloViews Overlay | [HoloViews Patterns](./patterns/holoviews-patterns.md) |
| Real-time streaming | WebSocket Streaming | [Panel Patterns](./patterns/panel-patterns.md) |
| API integration | FastAPI + Panel | [Integration Patterns](./patterns/integration-patterns.md) |
| Performance issues | Caching & Lazy Loading | [Performance Patterns](./patterns/performance-patterns.md) |

### By Data Size

| Data Size | Recommended Approach | Pattern |
|-----------|---------------------|---------|
| < 10K rows | Standard hvPlot | [HoloViews Patterns](./patterns/holoviews-patterns.md) |
| 10K - 100K rows | HoloViews + optimization | [Performance Patterns](./patterns/performance-patterns.md) |
| 100K - 10M rows | Datashader | [Datashader Patterns](./patterns/datashader-patterns.md) |
| 10M+ rows | Datashader + streaming | [Datashader Patterns](./patterns/datashader-patterns.md) |

### By Interactivity Needs

| Interactivity | Pattern | File |
|---------------|---------|------|
| Static plot | Basic hvPlot | [HoloViews Patterns](./patterns/holoviews-patterns.md) |
| Hover tools | HoloViews with tooltips | [HoloViews Patterns](./patterns/holoviews-patterns.md) |
| Selection/Linking | Streams | [HoloViews Patterns](./patterns/holoviews-patterns.md) |
| Full dashboard | Panel application | [Panel Patterns](./patterns/panel-patterns.md) |
| Real-time updates | Streaming | [Panel Patterns](./patterns/panel-patterns.md) |
...
1. **[Panel Patterns](./patterns/panel-patterns.md)** (Loaded when: Building Panel apps)
...
2. **[HoloViews Patterns](./patterns/holoviews-patterns.md)** (Loaded when: Composing visualizations)
   - Overlays and layouts
   - DynamicMaps
   - Custom operations
   - Interactive streams

3. **[Datashader Patterns](./patterns/datashader-patterns.md)** (Loaded when: Visualizing > 100K points)
   - Scatter plots
   - Time series
   - Custom aggregations
   - Dynamic colormapping

4. **[GeoViews Patterns](./patterns/geoviews-patterns.md)** (Loaded when: Creating maps)
   - Basemaps
   - Geographic overlays
   - CRS handling
   - Spatial analysis

5. **[Param Patterns](./patterns/param-patterns.md)** (Loaded when: Building parameter systems)
   - Validation
   - Dependencies
   - Watchers
   - Dynamic updates

6. **[Integration Patterns](./patterns/integration-patterns.md)** (Loaded when: Using multiple tools)
   - Panel + HoloViews
   - Datashader + HoloViews
   - FastAPI + Panel
   - Lumen extensions

7. **[Performance Patterns](./patterns/performance-patterns.md)** (Loaded when: Optimizing performance)
   - Caching
   - Lazy loading
   - Streaming
   - Async patterns

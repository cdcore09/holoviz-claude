...
**See**: [Performance Best Practices](./best-practices/performance.md)
...
**See**: [Panel Best Practices](./best-practices/panel.md)
...
**See**: [HoloViews Best Practices](./best-practices/holoviews.md)
...
**See**: [Param Best Practices](./best-practices/param.md)
...
**See**: [GeoViews Best Practices](./best-practices/geoviews.md)
...
**See**: [Code Organization Best Practices](./best-practices/code-organization.md)
...
**See**: [Testing Best Practices](./best-practices/testing.md)
...
**See**: [Deployment Best Practices](./best-practices/deployment.md)
...
**See**: [Accessibility Best Practices](./best-practices/accessibility.md)
...
|-------|----------|----------------|
| Planning | Architecture | [Code Organization](./best-practices/code-organization.md) |
| Development | Patterns | [Panel](./best-practices/panel.md), [HoloViews](./best-practices/holoviews.md) |
| Optimization | Speed | [Performance](./best-practices/performance.md) |
| Testing | Quality | [Testing](./best-practices/testing.md) |
| Documentation | Clarity | [Documentation](./best-practices/documentation.md) |
| Deployment | Reliability | [Deployment](./best-practices/deployment.md) |

### By Application Type

| App Type | Key Practices | Documents |
|----------|---------------|-----------|
| Dashboard | Reactivity, Layout | [Panel](./best-practices/panel.md) |
| Visualization | Composition, Style | [HoloViews](./best-practices/holoviews.md) |
| Big Data | Datashader, Caching | [Performance](./best-practices/performance.md) |
| Geographic | CRS, Tiles | [GeoViews](./best-practices/geoviews.md) |
| Public-facing | Accessibility | [Accessibility](./best-practices/accessibility.md) |

### By Problem

| Problem | Solution | Best Practice |
|---------|----------|---------------|
| Slow performance | Optimize data flow | [Performance](./best-practices/performance.md) |
| Hard to maintain | Improve structure | [Code Organization](./best-practices/code-organization.md) |
| Bugs in production | Add tests | [Testing](./best-practices/testing.md) |
| Users confused | Better docs | [Documentation](./best-practices/documentation.md) |
| Deployment issues | Follow deploy guide | [Deployment](./best-practices/deployment.md) |
...
**Read**:
- [Panel Best Practices](./best-practices/panel.md) OR
- [HoloViews Best Practices](./best-practices/holoviews.md) OR
- [GeoViews Best Practices](./best-practices/geoviews.md)
...
- [Accessibility Best Practices](./best-practices/accessibility.md)
...
- **[Panel Best Practices](./best-practices/panel.md)** - Dashboard development
- **[HoloViews Best Practices](./best-practices/holoviews.md)** - Visualization patterns
- **[Param Best Practices](./best-practices/param.md)** - Parameter systems
- **[GeoViews Best Practices](./best-practices/geoviews.md)** - Geographic visualization
- **[Code Organization Best Practices](./best-practices/code-organization.md)** - Project structure
- **[Testing Best Practices](./best-practices/testing.md)** - Testing strategies
- **[Documentation Best Practices](./best-practices/documentation.md)** - Writing docs
- **[Deployment Best Practices](./best-practices/deployment.md)** - Production deployment
- **[Accessibility Best Practices](./best-practices/accessibility.md)** - Inclusive design
